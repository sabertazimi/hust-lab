...
set_property IOSTANDARD LVCMOS33 [get_ports btn_pushed]

set_property PACKAGE_PIN U3 [get_ports phase_ended]
set_property IOSTANDARD LVCMOS33 [get_ports phase_ended]
