...
#set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets reset_flag_IBUF]
#set_property PACKAGE_PIN R7 [get_ports reset_flag]
#set_property IOSTANDARD LVCMOS33 [get_ports reset_flag]
