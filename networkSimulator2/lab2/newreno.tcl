...
set newReno0 [new Agent/TCP/Newreno]
$ns attach-agent $n0 $newReno0
set sink3 [new Agent/TCPSink]
$ns attach-agent $n3 $sink3
$ns connect $newReno0 $sink3
	$newReno0 set packetSize_ 1500.0
	$sink3 set packetSize_ 1500.0

#Setup a TCP/Newreno connection
set newReno1 [new Agent/TCP/Newreno]
$ns attach-agent $n1 $newReno1
set sink4 [new Agent/TCPSink]
$ns attach-agent $n3 $sink4
$ns connect $newReno1 $sink4
	$newReno1 set packetSize_ 1500.0
...
$ftp0 attach-agent $newReno0
$ns at 1.0 "$ftp0 start"
$ns at 2.0 "$ftp0 stop"

#Setup a FTP Application over TCP/Newreno connection
set ftp1 [new Application/FTP]
$ftp1 attach-agent $newReno1
