...
set vegas0 [new Agent/TCP/Vegas]
$ns attach-agent $n0 $vegas0
set sink2 [new Agent/TCPSink]
$ns attach-agent $n3 $sink2
$ns connect $vegas0 $sink2
	$vegas0 set packetSize_ 1500.0
	$sink2 set packetSize_ 1500.0

#Setup a TCP/Vegas connection
set vegas1 [new Agent/TCP/Vegas]
$ns attach-agent $n1 $vegas1
set sink3 [new Agent/TCPSink]
$ns attach-agent $n3 $sink3
$ns connect $vegas1 $sink3
	$vegas1 set packetSize_ 1500.0
