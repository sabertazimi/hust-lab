...
* [提前测试](#提前测试)
* [实验总体流程](#实验总体流程)
	* [四种学习目标和对应手段](#四种学习目标和对应手段)
* [实验内容](#实验内容)
	* [实验指导书](#实验指导书)
	* [实验题目](#实验题目)
	* [实验环境](#实验环境)
		* [一、[在线实验--基于"实验楼"在线平台](http://www.shiyanlou.com/courses/221)](#一在线实验--基于实验楼在线平台httpwwwshiyanloucomcourses221)
		* [二、Windows下基于MingW进行实验](#二windows下基于mingw进行实验)
		* [三、Windows下基于VirtualBox or VMWare进行实验](#三windows下基于virtualbox-or-vmware进行实验)
			* [1. 安装VirtualBox or VMWare软件](#1-安装virtualbox-or-vmware软件)
			* [2.使用已经预先安装好相关实验环境所需软件的虚拟硬盘](#2使用已经预先安装好相关实验环境所需软件的虚拟硬盘)
		* [四、在MAC OS下进行实验](#四在mac-os下进行实验)
			* [1.install [homebrew](http://brew.sh/)](#1install-homebrewhttpbrewsh)
			* [2.install binutils, gcc, gdb targeting i386-elf](#2install-binutils-gcc-gdb-targeting-i386-elf)
			* [3. install qemu-system-i386](#3-install-qemu-system-i386)
		* [五、手动在物理PC中安装环境](#五手动在物理pc中安装环境)
	* [实验中的练习步骤](#实验中的练习步骤)
	* [在线交流](#在线交流)
	* [开发维护人员](#开发维护人员)
	* [课程汇总信息](#课程汇总信息)
	* [UCORERS (代码贡献者)](#ucorers-代码贡献者)
	* [版权信息](#版权信息)
